...
proof -
  ...
  proof (rule ccontr)
    ...
    text \<open>INCOMPLETE: Would need to extract witness and show contradiction\<close>
    show False
      sorry  \<comment> \<open>Gap: extracting witness and deriving contradiction\<close>
  qed
qed
