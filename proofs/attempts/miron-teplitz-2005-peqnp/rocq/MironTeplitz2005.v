...
(**
  * What Would Be Formalized
  ...
  other proof attempts in this repository, using Rocq's type system
...
(**
  * Note on Verification
  ...
  In Rocq, adding an axiom without proof is similar to assuming
